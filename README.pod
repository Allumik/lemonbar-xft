...
I<lemonbar> [-h | -g I<width>B<x>I<height>B<+>I<x>B<+>I<y> | -b | -d | -f I<font> | -p | -n I<name> | -u I<pixel> | -B I<color> | -F I<color> | -U I<color> | -o I<offset> | -R <vertical-left> | -r <vertical-right> ]

=head1 DESCRIPTION

B<lemonbar> (formerly known as B<bar>) is a lightweight bar entirely based on XCB. Provides full UTF-8 support, basic formatting, RandR and Xinerama support and EWMH compliance without wasting your precious memory. Also enables you to save your precious vertical screenspace with new B<vertical mode>!
...
Dock the bar vertically to the left of the screen.

=item B<-r>

Dock the bar vertically to the right of the screen.
